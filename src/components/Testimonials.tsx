...
const FALLBACK_REVIEWS: Review[] = [
  ...
  { name: 'Sharmin Akter', initials: 'SA', city: { en: 'Bogura', bn: 'বগুড়া' }, rating: 5,
    text: { en: 'Ordered the rechargeable fan during heavy load-shedding. Battery lasts the whole evening. Their support team helped me set it up over WhatsApp.',
  ...
  { name: 'Tanvir Hossain', initials: 'TH', city: { en: 'Sylhet', bn: 'সিলেট' }, rating: 4,
    text: { en: 'COD worked smoothly all the way to Sylhet. The 48-egg unit is well built and the temperature is rock-stable. Recommended.',
  ...
  { name: 'Rakibul Islam', initials: 'RI', city: { en: 'Chattogram', bn: 'চট্টগ্রাম' }, rating: 5,
    text: { en: 'Replacement was honored within 4 days when one sensor was faulty. Honest sellers — rare these days. Will buy again.',
  ...
  { name: 'Nusrat Jahan', initials: 'NJ', city: { en: 'Khulna', bn: 'খুলনা' }, rating: 5,
    text: { en: 'The hygro-thermometer is super accurate. Pairs nicely with my older incubator. Fast shipping to Khulna.',
  ...
  { name: 'Abdul Karim', initials: 'AK', city: { en: 'Rajshahi', bn: 'রাজশাহী' }, rating: 5,
    text: { en: 'Industrial exhaust fan keeps my poultry shed cool and dry. Build quality is heavy-duty. Great after-sales response.',
