...
export const t = {
  ...
  bn: {
    ...
    hero: {
      ...
      subtitle:
        'নির্ভরযোগ্য অটোমেটিক ইনকিউবেটর, ইন্ডাস্ট্রিয়াল কুলিং ও স্মার্ট গ্যাজেট — উচ্চ হ্যাচ রেটের জন্য প্রকৌশলী, সারাদেশে ক্যাশ অন ডেলিভারিতে পৌঁছে দেওয়া হয়।',
      shop: 'পণ্য দেখুন',
      contact: 'এখনই কল করুন',
    },
    products: {
      micro: 'OUR CATALOG',
      title: 'সফল খামারের জন্য প্রস্তুত',
      subtitle:
        'ইন্ডাস্ট্রিয়াল মানের যন্ত্রপাতি, স্বচ্ছ মূল্য এবং বাংলাদেশের প্রতিটি জেলায় সরবরাহ।',
      all: 'সব', incubator: 'ইনকিউবেটর', fan: 'ফ্যান', gadgets: 'গ্যাজেট',
      stock: 'সীমিত স্টক', add: 'যোগ', view: 'বিস্তারিত দেখুন',
      specs: 'টেকনিক্যাল স্পেসিফিকেশন', addToCart: 'কার্টে যোগ করুন',
    },
    trust: {
      micro: 'WHY DHAKA INCUBATOR',
      title: 'সফল খামারিদের বিশ্বাস',
      cod: 'ক্যাশ অন ডেলিভারি',
      codDesc:
        'কার্টন দেখে, মডেল যাচাই করে কুরিয়ারকে সরাসরি নগদে পরিশোধ করুন। কোনো অগ্রিম পেমেন্টের প্রয়োজন নেই।',
      replace: '৭ দিনের রিপ্লেসমেন্ট',
      replaceDesc:
        'পণ্যে ত্রুটি পেলে হোয়াটসঅ্যাপে একটি ছোট ভিডিও পাঠান — ৭ কর্মদিবসের মধ্যে রিপ্লেসমেন্ট নিশ্চিত।',
      support: '২৪/৭ বিশেষজ্ঞ সহায়তা',
      supportDesc:
        'সেটআপ, হ্যাচিং পরামর্শ ও সমস্যা সমাধানে ফোন, হোয়াটসঅ্যাপ ও এসএমএসে সবসময় পাশে — ছুটির দিনেও।',
      delivery: 'সারাদেশে ডেলিভারি',
      deliveryDesc:
        'সুন্দরবন, এসএ পরিবহন ও RedX-এর মাধ্যমে ৬৪ জেলায় ডেলিভারি। ঢাকার ভেতরে ২৪–৪৮ ঘণ্টায় পৌঁছে দেওয়া হয়।',
    },
    cart: {
      title: 'আপনার কার্ট', empty: 'আপনার কার্ট এখনো খালি।', total: 'সর্বমোট',
      checkout: 'চেকআউট', name: 'পূর্ণ নাম', phone: 'মোবাইল নম্বর', address: 'ডেলিভারি ঠিকানা',
      confirm: 'হোয়াটসঅ্যাপে অর্ডার কনফার্ম করুন',
      hint: 'এটি আপনাকে অর্ডার বিবরণসহ হোয়াটসঅ্যাপে নিয়ে যাবে।',
      placeholder_name: 'যেমন: রহিম উদ্দিন', placeholder_phone: '01XXXXXXXXX',
      placeholder_address: 'বাড়ি, রোড, এলাকা, জেলা',
    },
    footer: {
      quick: 'কুইক লিংক', home: 'হোম', products: 'পণ্যসমূহ', warranty: 'ওয়ারেন্টি',
      warrantyTitle: 'ওয়ারেন্টি নীতিমালা',
      warrantyBody:
        'প্রতিটি ইনকিউবেটরে ইলেকট্রনিক যন্ত্রাংশের জন্য ১ বছরের সার্ভিস ওয়ারেন্টি প্রযোজ্য। ফ্যান ও গ্যাজেটে ৬ মাসের ওয়ারেন্টি প্রযোজ্য। অপব্যবহার, পানি প্রবেশ অথবা অননুমোদিত মেরামতজনিত ক্ষতি ওয়ারেন্টির আওতাভুক্ত নয়।',
      tagline: 'প্রিমিয়াম ইনকিউবেটর ও খামার ইলেকট্রনিক্স — আপনার খামারের সফলতার অংশীদার।',
